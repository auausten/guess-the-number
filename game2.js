...
function startGame() {
    ...
    randomNum = getRandomNumber(100); // Sets 100 as the maximum
...
// Actual gameplay (shows results)
    if (userValue > 100 || userValue < 1 || userValue % 1 != 0) {
        result.textContent = 'Please insert a value between 1 and 100';
